...
const PrivateRoute = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // if (isAuthenticated && currentPath === '/setPermanentPassword' && !isTempPass) {
    //   // Already reset password → go to home
    //   router.replace('/');
    //   return;
    // }

  }, [authLoading, isAuthenticated, isTempPass, currentPath, router]);
