            ...
            <div className='grid lg:grid-cols-3 grid-cols-1 gap-4'>
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex gap-4 sm:flex-row flex-col-reverse card bg-secondary text-white rounded-xl overflow-hidden md:p-6 p-4'>
                        ...
                        <img src={campaigns_new} alt='campaigns_new' width="164" height="127" className='sm:ms-auto' />
                    </div>
                </div>
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='card bg-card-color rounded-xl md:p-6 p-4'>
                        ...
                        <p className='text-font-color-100 mb-4'>
                            Augue mauris dignissim arcu, ut venenatis metus ante eu orci. Donec non maximus neque, ut finibus ex. <Link to="#" className='text-primary transition-all hover:text-secondary'>Read more</Link>
                        </p>
                    ...
                    <div className='card bg-card-color md:p-6 p-4 rounded-xl flex flex-col items-center'>
                        <img src={modal_joblisting} alt='modal popup' className='mb-6' />
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='card bg-card-color rounded-xl'>
                        <div className='md:p-6 p-4 border-b border-dashed border-border-color'>
                            ...
                            <div className='flex items-center flex-wrap gap-1 mb-4'>
                                ...
                                <img src={avatar4} alt='user' width="26" height="26" className='w-[26px] h-[26px] min-w-[26px] rounded-md' />
                            </div>
                    ...
                    <div className='card bg-card-color rounded-xl overflow-hidden md:mb-8 mb-6'>
                        ...
                        <div className='md:p-6 p-4 flex flex-wrap gap-4 border-t border-dashed border-border-color'>
                            <Link to="/page-pricing" className='btn btn-secondary'>
                                Upgrade Plan
                            </Link>
                            ...
                            <div className='py-10 md:px-10 px-[7px] bg-body-color'>
                                <div className='my-10 lg:px-20 md:px-10 px-[7px] md:max-h-[80svh] max-h-[60svh] overflow-auto cus-scrollbar'>
                                    ...
                                    <div className='card bg-card-color rounded-xl md:p-6 p-4 mb-2'>
                                        ...
                                        <h5 className="mt-6 text-[20px]/[24px] font-medium text-primary transition-all hover:text-secondary"><Link to="#">User Experience Designer Employee</Link></h5>
                                    ...
                                    <div className='card bg-card-color rounded-xl md:p-6 p-4'>
                                        ...
                                        <h5 className="mt-6 text-[20px]/[24px] font-medium text-primary transition-all hover:text-secondary"><Link to="#">Foreign Language Research Analyst</Link></h5>
                                        <ul className="flex flex-wrap gap-x-6 gap-y-1 my-4">
                                            <li className='flex items-center gap-2'><IconMapPin className='w-[18px] h-[18px] min-w-[18px]' /> New York, USA</li>
                                            <li className='flex items-center gap-2'><IconClockHour9 className='w-[18px] h-[18px] min-w-[18px]' /> Full Time</li>
                                        </ul>
