        ...
        <div>
            ...
            <div className='grid xxl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4'>
                <div className='card bg-card-color md:p-6 p-4 rounded-xl flex flex-col items-center'>
                    <img src={modal_connection} alt='modal popup' className='mb-6' />
                ...
                <div className='card bg-card-color md:p-6 p-4 rounded-xl flex flex-col items-center'>
                    <img src={modal_event} alt='modal popup' className='mb-6' />
                    <h5 className='text-[20px]/[24px] font-medium mb-2 text-center'>
                        Create Event
                    </h5>
                    <p className="text-font-color-100 mb-4 text-center">
                ...
                <div className='card bg-card-color md:p-6 p-4 rounded-xl flex flex-col items-center'>
                    <img src={modal_ordertracking} alt='modal popup' className='mb-6' />
                    <h5 className='text-[20px]/[24px] font-medium mb-2 text-center'>
                        Order Tracking
                    </h5>
                    <p className="text-font-color-100 mb-4 text-center">
                        ...
                        <div className='py-10 md:px-10 px-[7px] bg-card-color rounded-lg shadow-shadow-lg'>
                            <div className='my-10 lg:px-20 md:px-10 px-[7px] md:max-h-[80svh] max-h-[60svh] overflow-auto cus-scrollbar'>
                                ...
                                <ul className="flex flex-col md:gap-8 gap-6 mt-6">
                                    ...
                                    <li className="flex sm:items-center sm:gap-4 gap-2 sm:flex-row flex-col">
                                        <img src={avatar2} alt="user profile" className='rounded-md w-[36px] h-[36px] min-w-[36px]' />
                                        <div className='flex-grow'>
                                    ...
                                    <li className="flex sm:items-center sm:gap-4 gap-2 sm:flex-row flex-col">
                                        <img src={avatar3} alt="user profile" className='rounded-md w-[36px] h-[36px] min-w-[36px]' />
                                        <div className='flex-grow'>
                                    ...
                                    <li className="flex sm:items-center sm:gap-4 gap-2 sm:flex-row flex-col">
                                        <img src={avatar4} alt="user profile" className='rounded-md w-[36px] h-[36px] min-w-[36px]' />
                                        <div className='flex-grow'>
                        ...
                        <div className='py-10 md:px-10 px-[7px] bg-card-color rounded-lg shadow-shadow-lg'>
                            <div className='my-10 lg:px-20 md:px-10 px-[7px] md:max-h-[80svh] max-h-[60svh] overflow-auto cus-scrollbar'>
                                ...
                                <div className="bg-body-color md:p-4 p-2 mb-2 rounded-xl">
                                    ...
                                    <p>Swift Pro <span className="font-bold"><Link to="#" className='text-primary transition-all hover:text-secondary'>V504KO</Link></span></p>
                                </div>
                                <ul className='ms-100 border-s-[3px] border-secondary'>
                                    ...
                                    <li data-date="12:35 - Sun" className='relative mb-1 last:mb-0 py-2 px-4 before:content-[attr(data-date)] before:min-w-[100px] before:text-[12px]/[18px] before:text-start before:absolute before:end-[calc(100%+20px)] after:absolute after:w-15 after:h-15 after:bg-card-color after:top-10 after:rounded-full after:end-[calc(100%-6px)] after:border-[3px] after:border-primary'>
                                        ...
                                        <div className='flex items-center flex-wrap gap-1'>
                                            ...
                                            <img src={avatar1} alt='user' width="16" height="16" className='w-[16px] h-[16px] min-w-[16px] rounded-md' />
                                            <img src={avatar2} alt='user' width="16" height="16" className='w-[16px] h-[16px] min-w-[16px] rounded-md' />
                                            <img src={avatar3} alt='user' width="16" height="16" className='w-[16px] h-[16px] min-w-[16px] rounded-md' />
                                            <img src={avatar4} alt='user' width="16" height="16" className='w-[16px] h-[16px] min-w-[16px] rounded-md' />
                                        </div>
                                    </li>
                                    <li data-date="12:55 - Sun" className='relative mb-1 last:mb-0 py-2 px-4 before:content-[attr(data-date)] before:min-w-[100px] before:text-[12px]/[18px] before:text-start before:absolute before:end-[calc(100%+20px)] after:absolute after:w-15 after:h-15 after:bg-card-color after:top-10 after:rounded-full after:end-[calc(100%-6px)] after:border-[3px] after:border-primary'>
                                        ...
                                        <div>
                                            ...
                                            <Link to="#" className='flex items-center gap-1'>
                                                <img src={avatar6} alt='user' width="16" height="16" className='w-[16px] h-[16px] min-w-[16px] rounded-md' />
                                                Robert Hammer
                                            </Link>
                                        </div>
                                    </li>
