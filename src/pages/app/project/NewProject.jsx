                        ...
                        <div className='md:p-6 p-4'>
                            <TabPanel>
                                ...
                                <p className='small text-font-color-100 mb-4'>
                                    If you need more info, please check out <Link to="#" className='text-primary transition-all hover:text-secondary'>FAQ Page</Link>
                                </p>
                            ...
                            <TabPanel>
                                ...
                                <p className='small text-font-color-100 mb-4'>
                                    If you need more info, please check out <Link to="#" className='text-primary transition-all hover:text-secondary'>Project Guidelines</Link>
                                </p>
                                ...
                                <ul className='md:-mx-6 -mx-4 mb-6'>
                                    ...
                                    <li className='border-b border-dashed border-border-color md:px-6 p-4 flex items-start gap-3 cursor-pointer transition-all hover:bg-primary-10 last:border-b-0'>
                                        <img src={avatar8} alt='avatar' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                                        <div className='flex items-center gap-2 justify-between w-full truncate'>
                                            <div className='truncate'>
                                                <p className='truncate'>
                                                    Joge Lucky
                            ...
                            <TabPanel>
                                ...
                                <img src={project_team} alt='Project Team' width="787" height="428" />
                            </TabPanel>
                        </div>
                    </Tabs>
                </div>
