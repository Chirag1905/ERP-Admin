        ...
        <Tabs className='flex'>
            <div className={`bg-card-color min-w-[230px] w-[230px] p-4 xl:h-[calc(100svh-77px)] md:h-[calc(100svh-73px)] h-[calc(100svh-60px)] overflow-auto no-scrollbar lg:static fixed rounded-tl-2xl transition-all duration-300 ${projectSide ? 'z-[2] md:left-[13px] sm:left-2 left-0 shadow-shadow-lg' : '-left-full'}`}>
                ...
                <ul className='flex flex-wrap gap-3'>
                    <li>
                        <img src={avatar1} alt='user' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                    </li>
                    <li>
                        <img src={avatar2} alt='user' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                    </li>
                    <li>
                        <img src={avatar3} alt='user' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                    </li>
                    <li>
                        <img src={avatar4} alt='user' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                    </li>
                    <li>
                        <img src={avatar5} alt='user' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                    </li>
                </ul>
            </div>
