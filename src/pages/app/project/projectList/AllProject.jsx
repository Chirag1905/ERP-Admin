                ...
                <div className='card bg-card-color rounded-xl xxl:flex-[1_0_calc(33.33%-32px)] sm:flex-[1_0_calc(50%-16px)] flex-grow'>
                    <div className='md:p-6 p-4 border-b border-dashed border-border-color'>
                        ...
                        <div className='flex items-center flex-wrap gap-1 mb-4'>
                            ...
                            <img src={avatar5} alt='user' width="26" height="26" className='w-[26px] h-[26px] min-w-[26px] rounded-md' />
                ...
                <div className='card bg-card-color rounded-xl xxl:flex-[1_0_calc(33.33%-32px)] sm:flex-[1_0_calc(50%-16px)] flex-grow'>
                    <div className='md:p-6 p-4 border-b border-dashed border-border-color'>
                        ...
                        <div className='flex items-center flex-wrap gap-1 mb-4'>
                            ...
                            <img src={avatar8} alt='user' width="26" height="26" className='w-[26px] h-[26px] min-w-[26px] rounded-md' />
                            <img src={avatar9} alt='user' width="26" height="26" className='w-[26px] h-[26px] min-w-[26px] rounded-md' />
                            <img src={avatar10} alt='user' width="26" height="26" className='w-[26px] h-[26px] min-w-[26px] rounded-md' />
                        </div>
                        <div className='flex items-center justify-between gap-2 small'>
                            61%
                            <span>
