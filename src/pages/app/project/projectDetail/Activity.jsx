...
import { avatar1, avatar2, avatar3, avatar4, avatar6, avatar7, gallery1, gallery2, gallery5 } from '../../../../assets/images'
        ...
        <>
            ...
            <div className='project-activity card bg-card-color rounded-xl md:p-6 p-4'>
                <div className='p-4 md:pb-8 flex sm:flex-row flex-col sm:gap-4 gap-2 border-l border-border-color relative after:absolute after:h-[26px] after:w-[3px] after:top-4 after:left-[-2px] after:bg-secondary after:transition-all after:duration-300 hover:after:h-[calc(100%-3em)]'>
                    <img src={avatar1} alt='User' width="26" height="26" className='w-[26px] h-[26px] min-w-[26px] rounded-md' />
                    <div>
                        <p className='mb-1'>
                            Gerald Vaughn changed the status to QA on <Link to="#" className='text-primary transition-all hover:text-secondary'>MA-86</Link> - Retargeting Ads
                        </p>
                        <p className='small text-font-color-100'>
                            New Dashboard Design - 9:24PM by <Link to="#" className='text-primary transition-all hover:text-secondary'><strong>You</strong></Link>
                        </p>
                ...
                <div className='p-4 md:pb-8 flex sm:flex-row flex-col sm:gap-4 gap-2 border-l border-border-color relative after:absolute after:h-[26px] after:w-[3px] after:top-4 after:left-[-2px] after:bg-primary after:transition-all after:duration-300 hover:after:h-[calc(100%-3em)]'>
                    ...
                    <div>
                        <p className='mb-1'>
                            3 new screen design added: on <Link to="#" className='text-primary transition-all hover:text-secondary'>MA-86</Link>
                        </p>
                        <p className='small text-font-color-100'>
                            New added - 9:24PM by <Link to="#" className='text-primary transition-all hover:text-secondary'><strong>You</strong></Link>
                        </p>
                        <div className='md:p-4 md:mt-4 p-3 sm:mt-3'>
                            <div className='grid xxl:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-1'>
                                <div className='design-card rounded-xl overflow-hidden relative text-center group'>
                                    <img src={gallery1} alt='gallery' className='w-full opacity-60 saturate-50' />
                                    <div className='p-8 absolute left-0 top-0 w-full h-full before:absolute before:top-0 before:left-0 before:w-full before:h-full before:opacity-0 before:translate-y-[50%] before:transition-all before:duration-300 group-hover:before:opacity-100 group-hover:before:translate-y-0'>
                                        ...
                                        <Link to="/app-chat" className='absolute left-0 top-0 w-full h-full opacity-0 text-[0] z-[1]'>
                                            View more
                                        </Link>
                                    </div>
                                </div>
                                <div className='design-card rounded-xl overflow-hidden relative text-center group'>
                                    <img src={gallery2} alt='gallery' className='w-full opacity-60 saturate-50' />
                                    <div className='p-8 absolute left-0 top-0 w-full h-full before:absolute before:top-0 before:left-0 before:w-full before:h-full before:opacity-0 before:translate-y-[50%] before:transition-all before:duration-300 group-hover:before:opacity-100 group-hover:before:translate-y-0'>
                                        <h2 className="text-[24px]/[30px] font-medium absolute top-[50%] translate-y-[-50%] left-0 w-full transition-all duration-300 group-hover:text-white group-hover:translate-y-[-40px]">
                                            Todo App
                                        </h2>
                                        ...
                                        <Link to="/app-todo" className='absolute left-0 top-0 w-full h-full opacity-0 text-[0] z-[1]'>
                                            View more
                                        </Link>
                                    </div>
                                </div>
                                <div className='design-card rounded-xl overflow-hidden relative text-center group'>
                                    <img src={gallery5} alt='gallery' className='w-full opacity-60 saturate-50' />
                                    <div className='p-8 absolute left-0 top-0 w-full h-full before:absolute before:top-0 before:left-0 before:w-full before:h-full before:opacity-0 before:translate-y-[50%] before:transition-all before:duration-300 group-hover:before:opacity-100 group-hover:before:translate-y-0'>
                                        <h2 className="text-[24px]/[30px] font-medium absolute top-[50%] translate-y-[-50%] left-0 w-full transition-all duration-300 group-hover:text-white group-hover:translate-y-[-40px]">
                                            File Manager
                                        </h2>
                                        ...
                                        <Link to="/app-file-manager" className='absolute left-0 top-0 w-full h-full opacity-0 text-[0] z-[1]'>
                                            View more
                                        </Link>
                                    </div>
                                </div>
                ...
                <div className='p-4 md:pb-8 flex sm:flex-row flex-col sm:gap-4 gap-2 border-l border-border-color relative after:absolute after:h-[26px] after:w-[3px] after:top-4 after:left-[-2px] after:bg-chart-color4 after:transition-all after:duration-300 hover:after:h-[calc(100%-3em)]'>
                    ...
                    <div>
                        ...
                        <p className='small text-font-color-100'>
                            New file - 11:30AM by <Link to="#" className='text-primary transition-all hover:text-secondary'><strong>You</strong></Link>
                        </p>
                ...
                <div className='p-4 md:pb-8 flex sm:flex-row flex-col sm:gap-4 gap-2 border-l border-border-color relative after:absolute after:h-[26px] after:w-[3px] after:top-4 after:left-[-2px] after:bg-chart-color5 after:transition-all after:duration-300 hover:after:h-[calc(100%-3em)]'>
                    ...
                    <div>
                        <p className='mb-1'>
                            Create new module development team for <Link to="#" className='text-primary transition-all hover:text-secondary'>MA-86</Link> stocks for our Instagram channel
                        </p>
                        <p className='small text-font-color-100'>
                            ReactJs, Nodejs - 7:58AM by <Link to="#" className='text-primary transition-all hover:text-secondary'><strong>You</strong></Link>
                        </p>
                        <div className='md:p-4 md:mt-4 p-3 sm:mt-3'>
                            <p>
                        ...
                        <div className='flex gap-1 items-center mt-4'>
                            ...
                            <Link to="#" title='ReactJs'>
                                <img src={avatar1} width="16" height="16" alt='chat profile' className='w-[16px] h-[16px] min-w-[16px] rounded-md saturate-50 hover:saturate-100' />
                            </Link>
                            <Link to="#" title='NodeJs'>
                                <img src={avatar2} width="16" height="16" alt='chat profile' className='w-[16px] h-[16px] min-w-[16px] rounded-md saturate-50 hover:saturate-100' />
                            </Link>
                            <Link to="#" title='ReactJs'>
                                <img src={avatar3} width="16" height="16" alt='chat profile' className='w-[16px] h-[16px] min-w-[16px] rounded-md saturate-50 hover:saturate-100' />
                            </Link>
                            <Link to="#" title='ReactJs'>
                                <img src={avatar4} width="16" height="16" alt='chat profile' className='w-[16px] h-[16px] min-w-[16px] rounded-md saturate-50 hover:saturate-100' />
                            </Link>
                        </div>
                    </div>
                </div>
                <div className='p-4 md:pb-8 flex sm:flex-row flex-col sm:gap-4 gap-2 border-l border-border-color relative after:absolute after:h-[26px] after:w-[3px] after:top-4 after:left-[-2px] after:bg-chart-color3 after:transition-all after:duration-300 hover:after:h-[calc(100%-3em)]'>
                    <img src={avatar6} alt='User' width="26" height="26" className='w-[26px] h-[26px] min-w-[26px] rounded-md' />
                    <div>
                        <p className='mb-1'>
                            update new source code on GitHub <strong>MA-78 - Retargeting React Webapp</strong>
                        </p>
                        <p className='small text-font-color-100'>
                            New Dashboard Design - 9:24PM by <Link to="#" className='text-primary transition-all hover:text-secondary'><strong>Chris</strong></Link>
                        </p>
                ...
                <div className='p-4 md:pb-8 flex sm:flex-row flex-col sm:gap-4 gap-2 border-l border-border-color relative after:absolute after:h-[26px] after:w-[3px] after:top-4 after:left-[-2px] after:bg-chart-color1 after:transition-all after:duration-300 hover:after:h-[calc(100%-3em)]'>
                    <img src={avatar7} alt='User' width="26" height="26" className='w-[26px] h-[26px] min-w-[26px] rounded-md' />
                    <div>
                        <p className='mb-1'>
                            Task <Link to="#" className='text-primary transition-all hover:text-secondary'> #1425 </Link> merged with <Link to="#" className='text-primary transition-all hover:text-secondary'> #25836 </Link> in swift Admin Dashboard project :
                        </p>
                        <p className='small text-font-color-100'>
                            Updates for Jason Carroll - 7:12PM by <Link to="#" className='text-primary transition-all hover:text-secondary'><strong>Orlando</strong></Link>
                        </p>
                        <div className='md:p-4 md:mt-4 p-3 sm:mt-3'>
                            <p>
