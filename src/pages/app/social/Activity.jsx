        ...
        <>
            ...
            <div className='mb-4 md:p-6 p-4 rounded-xl bg-gradient-to-r from-primary to-secondary flex items-start flex-wrap xxl:gap-12 md:gap-6 gap-4'>
                <div className='relative inline-block'>
                    <img src={profile_av} alt='user profile' width="120" height="120" className='sm:w-[120px] sm:h-[120px] sm:min-w-[120px] w-[80px] h-[80px] min-w-[80px] object-cover sm:rounded-xl rounded-md' />
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='card rounded-xl bg-card-color md:p-6 p-4'>
                        <div className='flex items-center justify-between gap-2 md:mb-6 mb-4'>
                            <div className='flex gap-4 items-start'>
                                <img src={profile_av} alt='profile' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] object-cover rounded-md' />
                                <div>
                        ...
                        <div className='mb-4'>
                            <img src={gallery10} alt='social post' width="822" height="514" className='sm:rounded-xl rounded-md w-full' />
                        </div>
                        ...
                        <div className='bg-body-color p-4 flex sm:flex-row flex-col gap-x-4 gap-y-1 rounded-xl mb-1'>
                            <img src={avatar2} alt='avatar' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                        ...
                        <div className='bg-body-color p-4 flex sm:flex-row flex-col gap-x-4 gap-y-1 rounded-xl mb-4'>
                            <img src={avatar3} alt='avatar' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                            <div className='flex-1'>
                                <div className='flex items-center gap-2 justify-between'>
                                    <p className='truncate'>
                                        Robert Hammer
                        ...
                        <div className='bg-body-color p-4 flex sm:flex-row flex-col gap-x-4 gap-y-1 rounded-xl mb-1'>
                            ...
                            <div className='flex-1'>
                                ...
                                <div className='bg-card-color p-4 flex sm:flex-row flex-col gap-x-4 gap-y-1 rounded-xl'>
                                    <img src={avatar7} alt='avatar' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                                    <div className='flex-1'>
                                        <div className='flex items-center gap-2 justify-between'>
                                            <p className='truncate'>
                                                Andew Jon
                    ...
                    <div className='card rounded-xl bg-card-color md:p-6 p-4'>
                        ...
                        <div className='flex flex-wrap gap-5 mb-4'>
                            <img src={gallery1} width="110" height="69" alt='chat attachment' className='sm:rounded-xl rounded-md' />
                            <img src={gallery2} width="110" height="69" alt='chat attachment' className='sm:rounded-xl rounded-md' />
                            <img src={gallery3} width="110" height="69" alt='chat attachment' className='sm:rounded-xl rounded-md' />
                        </div>
                        <div className='bg-body-color p-4 flex sm:flex-row flex-col gap-x-4 gap-y-1 rounded-xl mb-1'>
                            <img src={avatar2} alt='avatar' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                            <div className='flex-1'>
                ...
                <div className='flex flex-col gap-4'>
                    <div className='card rounded-xl bg-card-color md:p-6 p-4'>
                        ...
                        <div className='flex gap-4 mb-6'>
                            <img src={profile_av} alt='profile' width="56" height="56" className='w-[56px] h-[56px] min-w-[56px] object-cover rounded-md' />
                            <div>
                        ...
                        <ul className='flex flex-col gap-4'>
                            ...
                            <li className='flex items-start flex-wrap'>
                                ...
                                <div className='gap-2 inline-flex'>
                                    <Link to="#" className='bg-primary text-white rounded w-[24px] h-[24px] min-w-[24px] inline-flex items-center justify-center transition-all hover:bg-secondary'>
                    ...
                    <div className='card rounded-xl bg-card-color md:p-6 p-4'>
                        ...
                        <div className="flex flex-wrap">
                            <img className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar1} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <img className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar2} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <img className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar3} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <img className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar4} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <img className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar5} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <img className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar6} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <img className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar7} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <img className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar8} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <img className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar9} title="Avatar Name" alt="User Profile" width="36" height="36" />
                            <img className="w-[36px] h-[36px] min-w-[36px] rounded-md m-1 transition-all hover:translate-y-[-3px]" src={avatar10} title="Avatar Name" alt="User Profile" width="36" height="36" />
                        </div>
                    </div>
                    <div className='card rounded-xl bg-card-color md:p-6 p-4'>
                        <div className='flex items-center justify-between gap-2 md:mb-6 mb-4'>
                        ...
                        <ul className='flex flex-col gap-1'>
                            <li className='bg-body-color p-4 flex gap-4 rounded-xl mb-1'>
                                <img src={avatar1} alt='avatar' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                                <div className='flex-1'>
                                    <p>
                                        Chris Fox
                                    </p>
                            ...
                            <li className='bg-body-color p-4 flex gap-4 rounded-xl mb-1'>
                                <img src={avatar4} alt='avatar' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                                <div className='flex-1'>
                                    <p>
                                        Alexander
                                    </p>
                    ...
                    <div className='card rounded-xl bg-card-color md:p-6 p-4'>
                        ...
                        <SlideshowLightbox showThumbnails onOpen={()=>{document.body.classList.add("overflow-hidden")}} onClose={()=>{document.body.classList.remove("overflow-hidden")}} className="grid grid-cols-3 gap-1">
                            {latestPhotos.map((item, key) => (
                                <img key={key} src={item.image} alt='gallery' className="rounded-md w-full" />
                            ))}
                        </SlideshowLightbox>
                    </div>
                </div>
