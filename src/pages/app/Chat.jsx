...
import { avatar1, avatar10, avatar2, avatar3, avatar4, avatar5, avatar6, avatar7, gallery3, gallery4, profile_av, video_call } from '../../assets/images';
                        ...
                        <Tabs>
                            ...
                            <div className='xl:h-[calc(100svh-77px-52px-75px)] md:h-[calc(100svh-73px-52px-75px)] h-[calc(100svh-60px-52px-75px)] overflow-auto no-scrollbar'>
                                ...
                                <TabPanel>
                                    ...
                                    <li className='border-b border-dashed border-border-color p-4 flex items-start gap-4 cursor-pointer transition-all hover:bg-body-color'>
                                        <img src={avatar10} alt='avatar' width="36" height="36" className='w-[36px] h-[36px] min-w-[36px] rounded-md' />
                                        <div className='truncate w-full'>
                                            <div className='flex items-center gap-2 justify-between'>
                                                <p className='truncate'>
                                                    Richard Foos
                    ...
                    <div className={`fixed p-15 w-full md:max-w-[800px] max-w-[500px] left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] z-[6]`}>
                        <div className='bg-card-color rounded-lg shadow-shadow-lg'>
                            <div className='sm:p-4 p-2 relative'>
                                <img src={video_call} alt='video call' width="766" height="511" />
                                <div className='sm:p-2 p-1 shadow-shadow-normal sm:rounded-xl rounded-md inline-block sm:mt-6 sm:me-6 mt-4 me-4 absolute end-0 top-0 bg-card-color'>
                                    <img src={profile_av} alt='video' width="160" height="160" className='md:w-auto sm:w-100 w-50' />
                                </div>
                            </div>
