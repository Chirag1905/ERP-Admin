                        ...
                        <table className='w-full min-w-[900px]'>
                            ...
                            <tbody>
                                <tr className='border-b border-dashed border-border-color last:border-b-0'>
                                    ...
                                    <td className='py-3 px-4 border-e border-dashed border-border-color last:border-e-0'>
                                        <Link to="#" className='text-primary transition-all hover:text-secondary'>HTML</Link>
                                        <span className="mx-4">|</span>
                                        <Link to="#" className='text-primary transition-all hover:text-secondary'>PDF</Link>
                                    </td>
                                </tr>
                                <tr className='border-b border-dashed border-border-color last:border-b-0'>
                                    <td className='py-3 px-4 border-e border-dashed border-border-color last:border-e-0'>
