...
const SectionToPrint = forwardRef((props, ref) => {
    return (
            ...
            <div className='md:p-40 p-6'>
                <div className='flex gap-4 justify-between items-start sm:flex-row flex-col-reverse pb-6 mb-6 border-b border-border-color'>
                    ...
                    <div className='relative inline-block'>
                        <img src={profile_av} alt='user profile' width="120" height="120" className='sm:w-[120px] sm:h-[120px] sm:min-w-[120px] w-[80px] h-[80px] min-w-[80px] object-contain sm:rounded-xl rounded-md' />
                    </div>
                </div>
...
SectionToPrint.displayName = 'SectionToPrint';
