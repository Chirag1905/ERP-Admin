                ...
                <div className='card bg-card-color rounded-xl grid xxl:grid-cols-[1fr_3fr] lg:grid-cols-[1.5fr_3fr] grid-cols-1'>
                    <TabList className="lg:border-r lg:border-b-0 border-b border-border-color">
                        <div className='md:p-6 p-4 border-b border-border-color'>
                            <img src={profile_av} width="90" height="90" alt="user profile" className="w-[90px] h-[90px] min-w-[90px] p-1 border border-border-color rounded-md"></img>
                        ...
                        <div className='md:p-6 p-4'>
                            ...
                            <ul className='flex flex-wrap gap-4'>
                                <li>
                                    <Link to="#" className='text-primary transition-all hover:text-secondary'>#bigdata</Link>
                                </li>
                                <li>
                                    <Link to="#" className='text-primary transition-all hover:text-secondary'>#design</Link>
                                </li>
                                <li>
                                    <Link to="#" className='text-primary transition-all hover:text-secondary'>#reactjs</Link>
                                </li>
                            </ul>
                        </div>
                    </TabList>
                    <div className='md:p-6 p-4'>
                        <TabPanel>
                            ...
                            <ul>
                                <li className='flex md:items-start md:flex-nowrap flex-wrap md:justify-normal justify-between md:gap-6 gap-4 md:py-6 py-4 md:border-none border-b border-dashed border-border-color'>
                                    <img src={gallery1} alt='bookmark thumbnail' width="120" height="75" className='w-[120px] h-[75px] object-cover rounded-md self-center' />
                                    <div className='md:order-2 order-3 flex-grow'>
                                        ...
                                        <Link to="#" className='inline-block text-primary mb-1 transition-all hover:text-secondary'>
                                ...
                                <li className='flex md:items-start md:flex-nowrap flex-wrap md:justify-normal justify-between md:gap-6 gap-4 md:py-6 py-4 md:border-none border-b border-dashed border-border-color'>
                                    <img src={gallery2} alt='bookmark thumbnail' width="120" height="75" className='w-[120px] h-[75px] object-cover rounded-md self-center' />
                                    <div className='md:order-2 order-3 flex-grow'>
                                        <h5 className='sm:text-[20px]/[24px] font-light mb-1'>
                                ...
                                <li className='flex md:items-start md:flex-nowrap flex-wrap md:justify-normal justify-between md:gap-6 gap-4 md:py-6 py-4 md:border-none border-b border-dashed border-border-color'>
                                    <img src={gallery3} alt='bookmark thumbnail' width="120" height="75" className='w-[120px] h-[75px] object-cover rounded-md self-center' />
                                    <div className='md:order-2 order-3 flex-grow'>
                                        <h5 className='sm:text-[20px]/[24px] font-light mb-1'>
                                ...
                                <li className='flex md:items-start md:flex-nowrap flex-wrap md:justify-normal justify-between md:gap-6 gap-4 md:py-6 py-4 md:border-none border-b border-dashed border-border-color'>
                                    <img src={gallery4} alt='bookmark thumbnail' width="120" height="75" className='w-[120px] h-[75px] object-cover rounded-md self-center' />
                                    <div className='md:order-2 order-3 flex-grow'>
                                        <h5 className='sm:text-[20px]/[24px] font-light mb-1'>
                                ...
                                <li className='flex md:items-start md:flex-nowrap flex-wrap md:justify-normal justify-between md:gap-6 gap-4 md:py-6 py-4 md:border-none border-b border-dashed border-border-color'>
                                    <img src={gallery5} alt='bookmark thumbnail' width="120" height="75" className='w-[120px] h-[75px] object-cover rounded-md self-center' />
                                    <div className='md:order-2 order-3 flex-grow'>
                                        <h5 className='sm:text-[20px]/[24px] font-light mb-1'>
                        ...
                        <TabPanel>
                            ...
                            <ul>
                                <li className='flex md:items-start md:flex-nowrap flex-wrap md:justify-normal justify-between md:gap-6 gap-4 md:py-6 py-4 md:border-none border-b border-dashed border-border-color'>
                                    <img src={gallery6} alt='bookmark thumbnail' width="120" height="75" className='w-[120px] h-[75px] object-cover rounded-md self-center' />
                                    <div className='md:order-2 order-3 flex-grow'>
                                        <h5 className='sm:text-[20px]/[24px] font-light mb-1'>
                                ...
                                <li className='flex md:items-start md:flex-nowrap flex-wrap md:justify-normal justify-between md:gap-6 gap-4 md:py-6 py-4 md:border-none border-b border-dashed border-border-color'>
                                    <img src={gallery7} alt='bookmark thumbnail' width="120" height="75" className='w-[120px] h-[75px] object-cover rounded-md self-center' />
                                    <div className='md:order-2 order-3 flex-grow'>
                                        <h5 className='sm:text-[20px]/[24px] font-light mb-1'>
