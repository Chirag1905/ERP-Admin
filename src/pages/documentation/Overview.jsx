        ...
        <>
            ...
            <div className='card bg-card-color rounded-xl md:p-6 p-4'>
                ...
                <div>
                    ...
                    <p className='md:text-[20px]/[30px] mb-15'>
                        If you really like our work, design, performance and support then <Link to="https://themeforest.net/" target='_blank' className='text-blue'> please don't forgot to rate us </Link> on Themeforest, it really motivate us to provide something better. &nbsp;
